...
<div class="content-wrapper">
    <div class="col-md-12">
        <div class="form h-100">
            <h3 style="font-weight: bold; color: #530986;">Tambah Event</h3>
            <form class="mb-5" method="POST" action="{{ url('event/store') }}" id="contactForm" name="contactForm">
                @csrf
                <div class="row">
                    <div class="col-md-6 form-group mb-3">
                        <label for="" class="col-form-label">Nama Event</label>
                        <input type="text" class="form-control" name="nama_event" id="nama_event" placeholder="Masukkan nama event">
                    </div>
                </div>
        ...
                </div>
                ...
                <div class="row">
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="deskripsi" id="deskripsi" placeholder="Sebutkan deskripsi event">
                    </div>
                </div>
