          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              <span class="text-muted d-block text-center text-sm-left d-sm-inline-block"> © 2024, SobatSehat</span> <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center" style="white-space: nowrap;"> Creative Team<span style="margin-right: 10px;"></span> About Us<span style="margin-right: 10px;"></span> Blog<span style="margin-right: 10px;"></span> License </span>
            </div>
          </footer>
          </div>
          <!-- main-panel ends -->
