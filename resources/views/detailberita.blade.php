        ...
        <div class="container">
            <footer class="row row-cols-5 py-5 border-top">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2">
                            <div class="col d-flex align-items-center">
                                ...
                                <span class="text-muted fs-6"> JRPV+QH5, Jl. Setu Indah No.116, Tugu, Kec. Cimanggis,
                                    Kota Depok, Jawa
                                    Barat 16451</span>
                            </div>
                        </li>
                ...
                <div class="col">
                    <div class="d-flex justify-content-center">
                        <a href="/" class="d-flex align-items-center mb-3 link-dark text-decoration-none p-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor"
                                class="bi bi-twitter-x" viewBox="0 0 16 16" style="color: #3A86FF;">
                                <path
                        ...
                        <a href="/" class="d-flex align-items-center mb-3 link-dark text-decoration-none p-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor"
                                class="bi bi-facebook" viewBox="0 0 16 16" style="color: #3A86FF;">
                                <path
                        ...
                        <a href="/" class="d-flex align-items-center mb-3 link-dark text-decoration-none p-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor"
                                class="bi bi-instagram" viewBox="0 0 16 16" style="color: #3A86FF;">
                                <path
                    ...
                    <p class="fs-6 text-muted">Ikuti kami di media sosial untuk informasi menarik, tips kesehatan, dan
                        keseruan
                        bersama Sobat Sehat. Jangan lewatkan setiap momen menyegarkan kehidupan Anda. 💚 #SobatSehat
                        #GerakBersama
                    </p>
                </div>
                <!-- Social Media Footer -->
